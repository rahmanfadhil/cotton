...
Deno.test("Column: default", () => {
  ...
  assertEquals(column2.toSQL("postgres"), "name VARCHAR(255) DEFAULT 'john'");
  ...
  assertEquals(column3.toSQL("postgres"), "is_published BOOLEAN DEFAULT false");
  ...
  assertEquals(column4.toSQL("postgres"), "created_at TIMESTAMP DEFAULT NOW()");
